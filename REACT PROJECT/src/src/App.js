...
class App extends Component {
  ...
  login() {
    ...
    email === "infant@gmail.com" && password === "infant" ? this.setState({
      user:{
        email : email,
        password : password    
      }
  ...
  updateEmployee(){
    ...
    this.state.editedProfession && (this.state.employeeList[edI].profession = this.state.editedProfession)
  ...
  updateEmail(e){
    ...
    updateProfession(e){
      this.setState({
        editedProfession : e.target.value
      })
      }
            ...
            <table className="table table-striped table-dark">
              <thead>
                <tr>
                  ...
                  <th scope="col" className="centerAll">Profession</th>
              ...
              {this.state.employeeList.map((value, index)=>{
                    return(
                      this.state.editIndex !== index ? <tr>
                            ...
                            <td className="centerAll" id={index+5}>{value.profession}</td>
                            <td className="centerAll" id={index+6}>Rs.{value.salary}/</td>
                            <td className="centerAll" id={index+7}>{value.joinDate}</td>
                          ...
                          <td className="centerAll" id={index+5+'edit'}><input type="text" defaultValue={value.profession} onChange={this.updateProfession} /></td>
                          <td className="centerAll" id={index+6+'edit'}><input type="text" defaultValue={value.salary} onChange={this.updateSalary}/></td>
                          <td className="centerAll" id={index+7+'edit'}><input type="text" defaultValue={value.joinDate}/></td>
    ...
    return(
      <div className="loginForm">
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" id="email2" aria-describedby="emailHelp" placeholder="Enter profession"/>
        </div>
        <div className="form-group">
          <label >Salary</label>
